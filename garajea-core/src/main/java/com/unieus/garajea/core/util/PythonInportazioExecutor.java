...
public class PythonInportazioExecutor {

    private final Path pythonExePath;
    private final Path scriptPath;

    public PythonInportazioExecutor() {
        ...
        this.scriptPath = baseDir.resolve(
            Paths.get("scripts", "inportatu_taula.py")
        );
    ...
    public int exekutatu(String taulaIzena, Path csvSarrera) {
        ...
        command.add(csvSarrera.toString());
