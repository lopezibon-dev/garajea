...
def apply_xslt_html(xml_path: Path, xslt_path: Path, output_path: Path):
    """
...
def apply_xslt_text(xml_path: Path, xslt_path: Path, output_path: Path):
    """
    XML bati XSLT orria ezarri eta testua sortu
    """
    ...
    logger.info("testua behar bezala sortua")